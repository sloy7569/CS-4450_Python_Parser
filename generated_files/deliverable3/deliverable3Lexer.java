...
public class deliverable3Lexer extends Lexer {
	...
	public static final int
		...
		LINECOMMENT=38, BLOCKCOMMENT=39, NEWLINE=40, WS=41;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "EQUALS", "PLUS_EQUALS", "MINUS_EQUALS", "TIMES_EQUALS", 
			"DIV_EQUALS", "LBRACKET", "RBRACKET", "COMMA", "COLON", "LPAREN", "RPAREN", 
			"IF", "ELIF", "ELSE", "WHILE", "FOR", "IN", "RANGE", "AND", "OR", "NOT", 
			"BOOLEAN", "STRING", "FLOAT", "NUMBER", "VAR", "LINECOMMENT", "BLOCKCOMMENT", 
			"NEWLINE", "WS"
		};
	}
